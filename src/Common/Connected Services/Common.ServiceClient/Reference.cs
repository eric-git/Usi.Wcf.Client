...
namespace Common.ServiceClient
{
    ...
    public partial class USIServiceClient : System.ServiceModel.ClientBase<Common.ServiceClient.IUSIService>, Common.ServiceClient.IUSIService
    {
        ...
        public System.Threading.Tasks.Task<Common.ServiceClient.BulkUploadResponse> BulkUploadAsync(Common.ServiceClient.BulkUploadRequest request)
        {
            return base.Channel.BulkUploadAsync(request);
        }
        
        public System.Threading.Tasks.Task<Common.ServiceClient.BulkVerifyUSIResponse> BulkVerifyUSIAsync(Common.ServiceClient.BulkVerifyUSIRequest request)
        {
            return base.Channel.BulkVerifyUSIAsync(request);
        }
        
        public System.Threading.Tasks.Task<Common.ServiceClient.VerifyUSIResponse> VerifyUSIAsync(Common.ServiceClient.VerifyUSIRequest request)
        {
            return base.Channel.VerifyUSIAsync(request);
        }
        
        public System.Threading.Tasks.Task<Common.ServiceClient.BulkUploadRetrieveResponse> BulkUploadRetrieveAsync(Common.ServiceClient.BulkUploadRetrieveRequest request)
        {
            return base.Channel.BulkUploadRetrieveAsync(request);
        }
        
        public System.Threading.Tasks.Task<Common.ServiceClient.CreateUSIResponse> CreateUSIAsync(Common.ServiceClient.CreateUSIRequest request)
        {
            return base.Channel.CreateUSIAsync(request);
        }
        
        public System.Threading.Tasks.Task<Common.ServiceClient.GetNonDvsDocumentTypesResponse> GetNonDvsDocumentTypesAsync(Common.ServiceClient.GetNonDvsDocumentTypesRequest request)
        {
            return base.Channel.GetNonDvsDocumentTypesAsync(request);
        }
        
        public System.Threading.Tasks.Task<Common.ServiceClient.UpdateUSIContactDetailsResponse> UpdateUSIContactDetailsAsync(Common.ServiceClient.UpdateUSIContactDetailsRequest request)
        {
            return base.Channel.UpdateUSIContactDetailsAsync(request);
        }
        
        public System.Threading.Tasks.Task<Common.ServiceClient.UpdateUSIPersonalDetailsResponse> UpdateUSIPersonalDetailsAsync(Common.ServiceClient.UpdateUSIPersonalDetailsRequest request)
        {
            return base.Channel.UpdateUSIPersonalDetailsAsync(request);
        }
        
        public System.Threading.Tasks.Task<Common.ServiceClient.LocateUSIResponse> LocateUSIAsync(Common.ServiceClient.LocateUSIRequest request)
        {
            return base.Channel.LocateUSIAsync(request);
        }
        
        public System.Threading.Tasks.Task<Common.ServiceClient.GetCountriesResponse> GetCountriesAsync(Common.ServiceClient.GetCountriesRequest request)
        {
