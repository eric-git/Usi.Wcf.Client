...
public class IssuerBindingUsiServiceClient(IKeystoreManager keystoreManager, IConfiguration configuration, ILogger<IUSIService> logger) : BaseUsiServiceClient(logger)
{
